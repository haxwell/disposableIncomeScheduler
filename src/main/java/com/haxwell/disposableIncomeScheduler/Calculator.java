...
public class Calculator {
	...
	private static class InnerCalculatePreviousSavedAmountHandler implements CalculatedPreviousSavedAmountHandler {
		@Override
	...
	public static long getDollarAmountToBeSpreadOverLongTermGoals(JSONObject data, JSONObject state) {
		return getDollarAmountToBeSpreadOverLongTermGoals(Calculator.getDollarAmountsToBeAppliedToGenericallyReservedFunds(data), Calculator.getDollarAmountsToBeAppliedToExpenses(data),
				Calculator.getDollarAmountsToBeAppliedToShortTermGoals(data, state), Calculator.getAmountsAlreadySavedForLongTermGoals(data));
	}

	public static long getDollarAmountToBeSpreadOverLongTermGoals(Map<String, Long> genericFundsMap, Map<String, Double> expenseMap, Map<String, Double> stgMap, Map<String, Double> ltgMap) {
	...
	public static void applyMoneyToLongTermGoals(JSONObject data, long totalDollarAmount) {
		...
		if (grpRootElement != null) {
			...
			do {
				...
				ApplyMoneyHelperReturnValue rtn = applyMoneyHelper(grpRootElement, weightsRootElement, totalDollarAmount, new InnerCalculatePreviousSavedAmountHandler());
